...
if __name__ == '__main__':
    ...
    # args.bert_dir = "../checkpoints/best.pt/"
    #args.bert_dir = "../model_hub/chinese-bert-wwm-ext/"
    args.bert_dir = r'D:/Code/nlp-data/pytorch_triple_extraction-main/pytorch_triple_extraction-main/model_hub/chinese-bert-wwm-ext'
    args.data_dir = "./data/"
    args.log_dir = "./logs/"
    args.output_dir = "./checkpoints/"
    args.num_tags = 5 # 根据rels.txt里面数目而定
    args.seed = 123
    args.gpu_ids = "0"
    ...
    tokenizer = BertTokenizer.from_pretrained(r'D:\Code\nlp-data\pytorch_triple_extraction-main\pytorch_triple_extraction-main\model_hub\chinese-bert-wwm-ext',local_files_only=True)
